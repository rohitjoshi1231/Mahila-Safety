...
class NavigateFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        (activity as? com.domingo.mahila_saftey.ui.activities.MainActivity)?.disableGestureDetection()
    }

    override fun onPause() {
        super.onPause()
        (activity as? com.domingo.mahila_saftey.ui.activities.MainActivity)?.enableGestureDetection()
    }
}